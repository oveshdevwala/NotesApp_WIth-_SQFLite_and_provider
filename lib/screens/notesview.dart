      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            IconButton(
                onPressed: () {
                  context.read<DatabaseProvider>().isUpdate = true;
                  context
                      .read<DatabaseProvider>()
                      .navigatorToUpdatePage(context, mindex);
                  // context.read<DatabaseProvider>().fieldValueToupdate(mindex);
                },
                style: TextButton.styleFrom(
                    backgroundColor: uiColors.icongrey,
                    shape: RoundedRectangleBorder(
              ...
              return Column(
                  ...
                  children: [
                    ...
                    Text(provider.data[mindex].modelDate,
                        style:
                            TextStyle(fontSize: 14, color: uiColors.textGrey)),
                    SizedBox(height: 8),
                    Text(
